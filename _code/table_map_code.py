...
map.set_title('Medicare FFS Hospital Visits per Population over 65 2015-2018 by Zip Code in Florida', fontdict = {'fontsize': 16}, loc = 'center')
map.set_axis_off()
...
map.add_artist(AnchoredSizeBar(map.transData, 5, '500 km', loc = 'lower left'))
